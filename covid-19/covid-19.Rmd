...
covidc <- function(county_state) {
  ...
  p <- ggplot(data = c, mapping = aes(x = date)) +
    ...
    scale_x_date(limits = as.Date(c(x_origin,
                                    Sys.Date()
                                    ),
                                  origin = "1960-10-01"
                          )
...
```{r eu, include = TRUE, out.width = "80%"}
...
eu_combined_cases %>%
  ggplot(mapping = aes(x = date)) +
    ...
    labs(
      subtitle = "COVID-19 Daily Case Rates:  European Union",
      x = "",
      y = "daily cases",
      color = ""
    ) +
...
us %>%
  ggplot(mapping = aes(x = date)) +
    ...
    labs(
      subtitle = "COVID-19 Daily Case Rates:  United States and European Union",
      x = "",
      y = "daily cases",
      color = ""
    ) +
...
p1 <- covid("California", "2020-09-01")
p2 <- covid("Texas", "2020-09-01")
p3 <- covid("Florida", "2020-09-01")
p4 <- covid("New York", "2020-09-01")
p5 <- covid("Illinois", "2020-09-01")
p6 <- covid("Pennsylvania", "2020-09-01")
p7 <- covid("Michigan", "2020-09-01")
p8 <- covid("Massachusetts", "2020-09-01")

```

<br><br>

```{r disp_state_charts, fig.asp=1.5}

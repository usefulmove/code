...
p1 <- covid("New York", "2020-10-15")
p2 <- covid("Ohio", "2020-10-15")
p3 <- covid("Wisconsin", "2020-10-15")
p4 <- covid("Illinois", "2020-10-15")
p5 <- covid("Pennsylvania", "2020-10-15")
p6 <- covid("Massachusetts", "2020-10-15")
p7 <- covid("Michigan", "2020-10-15")
p8 <- covid("Arizona", "2020-10-15")

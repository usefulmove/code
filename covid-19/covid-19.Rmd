...
p7 <- covid(state_alarm_sorted_df$state[7])
p8 <- covid(state_alarm_sorted_df$state[8])
p9 <- covid(state_alarm_sorted_df$state[9])
p10 <- covid(state_alarm_sorted_df$state[10])
p11 <- covid(state_alarm_sorted_df$state[11])
p12 <- covid(state_alarm_sorted_df$state[12])
p13 <- covid(state_alarm_sorted_df$state[13])
p14 <- covid(state_alarm_sorted_df$state[14])

```

<br><br>

```{r disp_state_charts, fig.asp=2.64}

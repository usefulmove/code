...
But this is useful **only in development code**. For production code, clean your code whenever possible.
...
As a convention, symbolic names are written with English words separated by hyphens.
...
- margin comments: 1 semicolon and it can have more spaces from code
